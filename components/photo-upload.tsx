...
import { Loader2, Camera, Upload, X, Sparkles, ImageIcon } from "lucide-react";
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      {!preview ? (
        <button
          ...
          className={cn(
            "w-full rounded-card border-2 border-dashed p-10 sm:p-14 text-center transition-all bg-white",
            dragOver
